...
namespace TerrainBruteForceApp
{
	class MainWindow
	...
	public:
		...
		//             scaleFactor - scale factor for the terrain heightmap.
		// Throws: Exception, std::bad_alloc
		MainWindow(HINSTANCE hInstance, const CommonLibOgl::WindowInfo& wndInfo,
			const CommonLibOgl::OpenGLInfo& openGLInfo, GLfloat terrainScaleFactor);
